...
Contributor information is provided in json format, in a file called
`contributors.json` which is at the root of your docs.

.. literalinclude:: ./contributors.json
    :language: json
    :linenos:
